...
class FaviconSorterTest {
    ...
    fun getBestIconForGuardian() {
        ...
        val favicons = listOf<Favicon>(Favicon("https://assets.guim.co.uk/images/favicons/1a3f98d8491f8cfdc224089b785da86b/144x144.png", FaviconType.AppleTouch, Size(144, 144)),
    ...
    fun getBestIconForGuardianIncludingRssIcon() {
        val bestIcon = Favicon("https://assets.guim.co.uk/images/guardian-logo-rss.c45beb1bafa34b347ac333af2e6fe23f.png", FaviconType.Icon, Size(250, 40))
