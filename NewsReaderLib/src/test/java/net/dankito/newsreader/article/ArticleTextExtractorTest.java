...
import net.dankito.newsreader.article.util.HtmlUtils;
...
import static net.dankito.newsreader.article.util.HtmlUtils.decompressStream;
...
//                "http://feeds.feedburner.com/ieeeSpectrumFullText"
    ...
    private void checkArticle(String articleUrl, String titleIndicator, String contentIndicator, int maxLength, int numberOfImgs, String[] excerpts) throws Exception {
        ...
        s = HtmlUtils.improveHtmlContent(s, getBaseUrl(con.getURL().toURI().toString())); //make image paths absolute
...
//        }
        ...
        if (doc.text().length() < maxLength) {
            ...
            String mobilizedHtml = HtmlUtils.improveHtmlContent(s, getBaseUrl(articleUrl));
